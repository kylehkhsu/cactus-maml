...
python3 main.py \
    ...
    --metatrain_iterations=240000 --meta_batch_size=4 --mt_mode=semi --mv_mode=gtgt \
    --logdir=./log/imagenet/20181202/resnet_semi_84 \
    --test_set=False --train=True \
    --resnet=True --num_res_blocks=5 --num_parts_per_res_block=2
