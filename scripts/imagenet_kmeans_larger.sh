...
python3 main.py \
        ...
        --inner_update_batch_size_train=1 --inner_update_batch_size_val=5 --outer_update_batch_size=15 \
        --num_filters=64 --norm=batch_norm --max_pool=True --update_lr=0.05 --num_updates=5 \
        --metatrain_iterations=120000 --meta_batch_size=16 --mt_mode=encenc --mv_mode=gtgt \
        --logdir=./log/imagenet/20181106/cactus \
