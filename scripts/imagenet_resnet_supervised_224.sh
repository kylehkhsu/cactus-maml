...
python3 main.py \
    ...
    --metatrain_iterations=240000 --meta_batch_size=4 --mt_mode=gtgt --mv_mode=gtgt \
    --logdir=./log/imagenet/20181114/resnet224 \
...
do
    python3 main.py \
        --dataset=imagenet --input_type=images_224x224 --encoder=deepcluster --partition_algorithm=kmeans \
        --num_classes_train=5 --num_classes_val=5 --num_clusters=-1 --num_partitions=3 \
